 ...
 * Slug: alladiyally/page-blog
 * Description: A sample home page with a welcome section, features, and a posts grid.
...
<div class="wp-block-group alignfull welcome" style="margin-top:0px;padding-top:70px;padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<h2 class="wp-block-heading has-text-align-center has-max-72-font-size" style="margin-bottom:0px;letter-spacing:-1px"><?php echo esc_html__( 'Experience the latest generation of WordPress.', 'frost' ); ?></h2>
	<!-- /wp:heading -->
